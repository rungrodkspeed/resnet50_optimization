...
if __name__ == '__main__':
    ...
    parser.add_argument('--onnx_path', type=str, default='./checkpoints/resnet50.onnx', help='onnx Path.')
    ...
    parser.add_argument('--trt_path', type=str, default='./checkpoints/resnet50.plan', help='tensorrt Path.')
