...
from utils import ImageProcessor, get_path, classes, EPSILON, dtype_np
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path', type=str, default='../checkpoints/resnet50_FLOAT.plan', help='model path')
